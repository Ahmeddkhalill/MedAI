...
public interface IBookingService
{
    ...
    Task<Result> CancelAsync(int bookingId, CancellationToken cancellationToken = default);
    Task<Result<PatientDashboardResponse>> GetPatientDashboardAsync(CancellationToken cancellationToken = default);
