...
public interface IXrayService
{
    ...
    Task<Result<UnrevisedXrayResponse>> GetUnrevisedXrayByIdAsync(int xrayId, CancellationToken cancellationToken = default);
    ...
    Task<Result<PaginatedList<DoctorXrayHistoryResponse>>> GetMyWorkedXraysAsync(RequestFilters filters, CancellationToken cancellationToken = default);
    Task<Result<DoctorXrayHistoryResponse>> GetMyWorkedXrayByIdAsync(int xrayId, CancellationToken cancellationToken = default);
